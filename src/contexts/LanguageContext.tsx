...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    "contact.workingHoursValue": "الإثنين - الجمعة: 9:00 - 18:00",
    ...
    "location.addressValue": "شارع محمد الخامس، رقم 123",
    "location.addressValue2": "الحي التجاري، الدار البيضاء",
    "location.addressValue3": "المغرب",
  ...
  fr: {
    ...
    "contact.workingHoursValue": "Lundi - Vendredi: 9h00 - 18h00",
    ...
    "location.addressValue": "Boulevard Mohammed V, numéro 123",
    "location.addressValue2": "Quartier commercial, Casablanca",
    "location.addressValue3": "Maroc",
